const translations = {
    en: {
        ...
        cart: { empty: 'Your cart is empty', total: 'Total:', checkout: 'Proceed to Checkout', coupon: 'Coupon code', apply: 'Apply' },
    ...
    af: {
        ...
        cart: { empty: 'Jou mandjie is leeg', total: 'Totaal:', checkout: 'Gaan na Betaalpunt', coupon: 'Koeeponkode', apply: 'Pas toe' },
    ...
    ts: {
        ...
        cart: { empty: 'Kaleni ya wena a yi ri hava nchumu', total: 'Nkatsakanyo:', checkout: 'Yisa eka malihelo', coupon: 'Khowe ya kupohe', apply: 'Kombela' },
